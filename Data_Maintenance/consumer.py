...
# data contains the bytes to be compressed
# level is an integer value that can take the vvalues -1 to 0 to 9
    ...
    try:
        while True:
            ...
            if msg is None:
                ...
                # data = 'e'
                compressed_data = zlib.compress(record_value, 1)
